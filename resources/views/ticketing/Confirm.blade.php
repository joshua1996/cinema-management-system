@extends('master') @section('sidebar')
    ...
    <section class="bkf-layout" id="seat-layout" style="display: block;overflow: inherit;">

        <div class="container">
            <header class="bkf-header">
                <span id="disback" class="st-back-btn"><a href="{{ route('byMovie', ['movieID' => $hallseat[0]->movieID, 'showingDate' => $hallseat[0]->showingTime]) }}"><img class="icon icons8-Back-Filled" width="20" height="20" src="data:image/png;base64,"></a></span>
                <div class="header-container">
                    <h2>
                        <!-- Event name -->
                        <span class="__event-name"><a id="strEvtName"
                                                      href="/movies/brindhaavanam/ET00057481">{!!$hallseat[0]['name']!!}</a></span>
            ...
            <span id="strDate" style="display: inline-block;">{!!$hallseat[0]['showingTime']!!}
                , {!!$hallseat[0]['time']!!}</span>
            <br>
            <span id="strVenName">{!!$hallseat[0]['cinema']!!}</span>
                    ...
                    <div class="event-components" id="evcomp" style="display: none;">
                        <div id="mob-qty" class="mob-btn" onclick="javascript:BMS.Misc.modal('qty-sel', 1);">No. OF
                            TICKETS | <span id="mobintQty">6</span></div>
                        <div id="mob-stm" class="mob-btn" onclick="javascript:BMS.Misc.modal('show-sel', 1);">
                            SHOWTIMES
                        </div>
                        <div></div>
            ...
            <section id="bksmile" class="bkf-container _add-ons struktur" style="display: block;">
                        ...
                        <div class="fnb-section">
                            <div class="block">
                                ...
                                <div class="exclusive-fullmenu-container" style="display:none;">
                                    <div class="tabs-menu tabs-active"
                                         onclick="exclFullmenuCategorization(this, 'EXCLUSIVE');"> EXCLUSIVE MENU
                                    </div>
                                    <div class="tabs-menu" onclick="exclFullmenuCategorization(this, 'FULL');"> CINEMA
                                        MENU
                                    </div>
                                </div>
                                <span class="sub-head fc-text" id="text-none"><span
                                            class="highlight-text">Exclusively </span>available on BookMyShow!</span>
               ...
               RM {!!$value['price']!!}
                                                    ...
                                                    <div class="company-logo" style="display: none;"><img
                                                                src="//in.bmscdn.com/inventory/company/web/ABMM.jpg">
                                                    </div>
                                                </div>
                                                <div class="description" id="desc_1011359">
                                                    ...
                                                    <div class="item-desc">
                                                        <h2><span class="_veg"></span><span
                                                                    class="detail-sname item-sname">{!!$value['name']!!}</span>
                                                        </h2>
                                                        <p class="tr-desc"
                                                           style="display: block;">{!!$value['foodDetail']!!}</p>
                                                        <p style="display: none;" class="detail-desc">Puri + Dosa +
                                                            Sambar Vada + Pongal + Sweet + Fresh Juice 250ml</p>
                                                    </div>
                                                    <div class="qty" style="top: 35px;">
                                                        <span id="add-btn_1011359" class="add-btn"
                                                              foodname="{!!$value['name']!!}"
                                                              price="{!!$value['price']!!}">ADD</span>
                                                        <span id="rm_1011359" style="display:none;" class="icon-minus"
                                                              foodname="{!!$value['name']!!}" cal="add">+</span>
                                                        <span id="FD_1011359" class="__holder"></span>
                                                        <span id="add_1011359" style="display:none;" class="icon-minus"
                                                              foodname="{!!$value['name']!!}" cal="remove">-</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </aside>
              ...
              <ol>
                ...
                <li>Prices inclusive of taxes</li>
                        ...
                        <div id="DTLP" class="__transaction-info" style="display: none;">
                            <ol>
                                <li><strong>1.</strong> Children above 2 years will require full ticket. They will not
                                    be allowed inside without tickets, and NO refund for tickets either.
                                </li>
                                <li><strong>2.</strong> Water, Eatables, Cigarette, Paan, Tobacco, Lighter, Matchbox,
                                    Drinks, Alcohol, etc. shall <strong><i><u>STRICTLY NOT</u></i></strong> be permitted
                                    inside the premises.
                                </li>
                                <li><strong>3.</strong> Patrons under influence of alcohol shall <strong><i><u>STRICTLY
                                                NOT</u></i></strong> be permitted inside the premises.
                                </li>
                            </ol>
                        </div>
              ...
              Collect the tickets 30 mins prior to the show.<br>
                        ...
                        <div class="__transaction-info" id="dPrithviNotes" style="display: none;">
                            ...
                            <ol style="margin: 5px 0 0 20px; list-style-type: decimal;">
                                ...
                                <li>In case of a children's show, children below the age of 3 years will not be allowed
                                    to enter.
                                </li>
                                <li>Vehicles cannot be parked inside Janki Kutir.</li>
                                <li>The Pay &amp; Park, located opposite Mahesh Lunch Home, can be used for parking.
                                </li>
                            </ol>
                        </div>
                        <div class="__transaction-info" id="inoxnotes" style="display: none;">
                            ...
                            <ul style="margin: 5px 0 0 8px; list-style-type: decimal;">
                                <li>Children above the age of 3 will need a separate ticket ,children will not be
                                    allowed in Adult movie .
                                </li>
                                <li>Please carry a valid age proof for A rated movies -18 years and over only would be
                                    given entry .
                                </li>
              ...
              2. You can only pay online to confirm your booking upto <strong class="cuthour"></strong> before the show.<br>
                ...
                <div class="bkf-order-summary-container">
                    <div class="order-summary-section">
                                ...
                                <ul class="__details">
                                    <li>
                                        <div class="__ticket-cat">
                                            ...
                                            <span id="TickCat" class="__seat-type">{!!implode(',', $seatArr)!!}<span
                                                        id="TickQuantity"> ( {!!count($seatArr)!!}
                                                    Tickets )</span></span>

                                        </div>
                                        @php $price = count($seatArr) * $hallseat[0]['price']; @endphp
                                        <div><span id="seatPri"
                                                   class="__seat-price">RM {!!number_format($price, 2)!!}</span></div>
                                    </li>
                        ...
                        <svg width="100%" height="100%" version="1.1" xmlns="//www.w3.org/2000/svg"
                             xmlns:xlink="//www.w3.org/1999/xlink" x="0px" y="0px" enable-background="new 0 0 100 100"
                             xml:space="preserve">
                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                             xlink:href="/icons/fnb-icons.svg#icon-downwards"></use></svg>
                      </span>
                                                <span class="__down-icon down-icon-tax"
                                                      onclick="showTaxBreakup('hide', this)" style="display:none;">
                        <svg width="100%" height="100%" version="1.1" xmlns="//www.w3.org/2000/svg"
                             xmlns:xlink="//www.w3.org/1999/xlink" x="0px" y="0px" enable-background="new 0 0 100 100"
                             xml:space="preserve">
                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                             xlink:href="/icons/fnb-icons.svg#icon-dropdown"></use></svg>
                      </span>
                                        ...
                                        <div class="__breakdown" id="intHandlingFeeBreakdown">
                                            <ul>
                                                <li>
                                                    <span>Booking Fees</span><span>RM {!!$hallseat[0]['bookingFee']!!}</span>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li class="_total-section">
                                        ...
                                        <div><span id="subTT"
                                                   class="__sub-total">RM {!!number_format($price + $hallseat[0]['bookingFee'], 2)!!}</span>
                                        </div>
                                    </li>
                        ...
                        <use xmlns:xlink="http://www.w3.org/1999/xlink"
                             xlink:href="/icons/fnb-icons.svg#icon-dropdown"></use></svg>
                                    ...
                                    <li style="display: none;">
                                        <h3 id="cpnfdd" class="__fnb-section" style="display:none;">Coupons <a
                                                    id="cpnfdAll" onclick="showCoupons('cpnDeta','cpnfdAll');"
                                                    href="javascript:;">Hide All</a></h3>
                                    </li>
                                    <li style="display: none;">
                            ...
                            <div class="_total-section amt-payable">
                                ...
                                <div><span id="ttPrice"
                                           class="__amount-payable">RM {!!number_format($price + $hallseat[0]['bookingFee'], 2)!!}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="__order-summary-btn">
                            ...
                            <a id="prePay" class="btn _cuatro __fnb-btn" href="#" style="display: inline-block;"><span
                                        class="__totalinbtn" style="display: inline;">TOTAL: <span
                                            id="PayTotal">RM {!!number_format($price + $hallseat[0]['bookingFee'], 2)!!}</span></span>Proceed</a>
                            <a id="payLat" class="btn _cuatro" style="display:none;" href="javascript:;">Please Login
                                First!</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="__busy-div-overlay" style="display: none;"></div>
        <div id="dBusy" class="busy-div" style="display: none;">
            <div class="container">
                ...
                <div class="movie-loader">
		            ...
		            <style>
                        ...
                        .style5 {
                            ...
                            <g>
                                <path d="M137.4 160.9H8.4 c-2.2 0-4-1.8-4-4V81.6c0-2.2 1.8-4 4-4h129c2.2 0 4 1.8 4 4v75.3C141.4 159.1 139.6 160.9 137.4 160.9z"
                                      class="style4"></path>
                                <path d="M188.5 141.7l-32.2-8.5 c-4.3-1.5-7.1-3.2-7.1-7.1v-17c0-3.9 2.2-5.2 7.1-7.1l32.2-9.1c3.9 0 7.1 3.2 7.1 7.1v34.6C195.6 138.4 192.4 141.7 188.5 141.7z"
                                      class="style4"></path>
                            </g>
		        </svg>
                    </div>
            ...
            <div class="adMagnet" style="width:300px; height:250px; margin:0 auto; text-align:center;">
                ...
                <div id="div-gpt-ad-1465364586930-0">
                    <script type="text/javascript">
                        googletag.cmd.push(function () {
                            googletag.display('div-gpt-ad-1465364586930-0');
                        });
                    </script>
                </div>
            </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $('#prePay').on('click', function () {
                    $('.__busy-div-overlay').css('display', 'block');
                    $('#dBusy').css('display', 'block');
                    $.get('/checklogin', function (data) {
                        data.status == false ? $('#payLat').show() : goToPay();
                    })
                });

                $('#payLat').on('click', function () {
