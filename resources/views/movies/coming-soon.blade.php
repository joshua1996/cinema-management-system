                ...
                <div class="mv-section-head">
                    ...
                    <div class="__tab-row">
                        <div class="btn-group">
                            ...
                            <a class="btn _uno tab-btn " id="coming-soon-btn"  href="/chennai/movies/comingsoon" >COMING SOON</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
  $(document).ready(function(){
    // $('.language input[type=checkbox]').on('change', function(){
    //      var data = { 'languages' : []};
    ...
    //     $.ajax({
    //         type:'post',
    //         url: '/movie/now-showing/language',
    //         data: data,
    //         success: function(data){
    //             $('.mv-row').empty().append(data);
    //         }
    //     });
    // });
