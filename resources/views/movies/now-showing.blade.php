    ...
    <div class="top-banner-wrapper" style="position: relative;">
        ...
        <div class="showcase" id="showcase-primary">
            <div class="section-body showcase-carousel slick-initialized slick-slider">
                ...
                <ul class="bxslider">
                    @foreach($moviePoster as $i=>$value)
                        <li><img src="/img/moviePoster/{{ $value->posterImg }}"/></li>
                    @endforeach
                </ul>
            ...
            <div class="mv-type-selection">
                <div class="mv-section-header">
                    <div class="mv-section-head">
                        ...
                        <div class="__tab-row">
                            <div class="btn-group">
                                <a class="btn _uno tab-btn _active" id="now-showing-btn"
                                   href="{{ route('nowshowing') }}">NOW SHOWING</a>
                                <a class="btn _uno tab-btn " id="coming-soon-btn" href="{{ route('comingsoon') }}">COMING
                                    SOON</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <section class="now-showing filter-now-showing">
                        ...
                        <div class="row">
                            ...
                            <div class="__col-filters">
                                ...
                                <div class="search-container search-pagewise">
                                    ...
                                    <span class="twitter-typeahead" style="position: relative; display: inline-block;">
                                        <input type="text" id="ajax-typeahead" class="__seach-input typeahead tt-input"
                                               placeholder="Search for Movies" autocomplete="off"
                          ...
                          <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                               ...
                               enable-background="new 0 0 100 100" xml:space="preserve"><use
                                      xlink:href="/icons/common-icons.svg#icon-cancel"></use></svg>
                        </span>
                                </span>
                                </div>
                              ...
                              <input type="checkbox" value="Chinese"> <span class="checkbox-label"><a
                                                        class="_anchor-filter">Chinese</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span class="__checkbox">
                              <input type="checkbox" value="English"> <span class="checkbox-label"><a
                                                        class="_anchor-filter">English</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span class="__checkbox">
                              <input type="checkbox" value="Malay"> <span class="checkbox-label"><a
                                                        class="_anchor-filter">Malay</a></span>
                                        </span>
                                        </p>
                                ...
                                <div class="filters genre-filter">
                                    ...
                                    <div class="genre __filter-list">
                                        ...
                                        <p class="__filter">
                                        <span class="__checkbox">
                              <input type="checkbox" value="Action"> <span class="checkbox-label"><a
                                                        class="_anchor-filter" href="/chennai/movies/action">Action</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="adventure" class="__checkbox">
                              <input type="checkbox" value="Adventure"> <span class="checkbox-label"><a
                                                        class="_anchor-filter" href="/chennai/movies/adventure">Adventure</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="animation" class="__checkbox">
                              <input type="checkbox" value="Animation"> <span class="checkbox-label"><a
                                                        class="_anchor-filter" href="/chennai/movies/animation">Animation</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="biography" class="__checkbox">
                              <input type="checkbox" value="Biography"> <span class="checkbox-label"><a
                                                        class="_anchor-filter" href="/chennai/movies/biography">Biography</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="comedy" class="__checkbox">
                              <input type="checkbox" value="Comedy"> <span class="checkbox-label"><a
                                                        class="_anchor-filter" href="/chennai/movies/comedy">Comedy</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="drama" class="__checkbox">
                              <input type="checkbox" value="Drama"> <span class="checkbox-label"><a
                                                        class="_anchor-filter"
                                                        href="/chennai/movies/drama">Drama</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="family" class="__checkbox">
                              <input type="checkbox" value="Family"> <span class="checkbox-label"><a
                                                        class="_anchor-filter" href="/chennai/movies/family">Family</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="fantasy" class="__checkbox">
                              <input type="checkbox" value="Fantasy"> <span class="checkbox-label"><a
                                                        class="_anchor-filter"
                                                        href="/chennai/movies/fantasy">Fantasy</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="horror" class="__checkbox">
                              <input type="checkbox" value="Horror"> <span class="checkbox-label"><a
                                                        class="_anchor-filter" href="/chennai/movies/horror">Horror</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="romance" class="__checkbox">
                              <input type="checkbox" value="Romance"> <span class="checkbox-label"><a
                                                        class="_anchor-filter"
                                                        href="/chennai/movies/romance">Romance</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="sci-fi" class="__checkbox">
                              <input type="checkbox" value="Scifi"> <span class="checkbox-label"><a
                                                        class="_anchor-filter"
                                                        href="/chennai/movies/scifi">Sci-fi</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="sports " class="__checkbox">
                              <input type="checkbox" value="Sports"> <span class="checkbox-label"><a
                                                        class="_anchor-filter" href="/chennai/movies/sports">Sports </a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span data-filter="thriller" class="__checkbox">
                              <input type="checkbox" value="Thriller"> <span class="checkbox-label"><a
                                                        class="_anchor-filter"
                                                        href="/chennai/movies/thriller">Thriller</a></span>
                                        </span>
                                        </p>
                                        <!-- <span class="__more-filters"> + More</span> -->
                                    </div>
                                ...
                                <div class="filters">
                                    ...
                                    <div class="format __filter-list">
                                        <p class="__filter">
                                        <span class="__checkbox">
                              <input type="checkbox" value="2D"> <span class="checkbox-label"><a class="_anchor-filter"
                                                                                                 href="/chennai/movies/2d">2D</a></span>
                                        </span>
                                        </p>
                                        <p class="__filter">
                                        <span class="__checkbox">
                              <input type="checkbox" value="3D"> <span class="checkbox-label"><a class="_anchor-filter"
                                                                                                 href="/chennai/movies/3d">3D</a></span>
                                        </span>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="mv-row">
                                    @foreach ($showing as $key => $value)
                                        ...
                                        <div class="wow fadeIn movie-card-container"
                                             ...
                                             languages="{!!$value['languages']!!}" genre="{!!$value['genre']!!}">
                                            <div class="movie-card ns-card-single">
                                                <div class="card-container">
                                                    <div class="poster-container-img">
                                                        <img class="__poster"
                                                             src="{{URL::to('/img/')}}/{!!$value['movieImg']!!}">
                                                    </div>
              ...
              <span>RECOMMENDED</span>
                                                        ...
                                                        <div class="show-more-info non-touch">
                                                            <ul class="info-list">
                                                                <li class="info-list-elements"><span class="tooltip">INFO</span><a
                                                                            href="/movie/{!!$value['movieID']!!}"><span
                                                                                class="info-icon white-icon"></span></a>
                                                                </li>
                                                    ...
                                                    <div class="detail">
                                                        <div class="__name overflowEllipses">
                                                            <a class="__movie-name"
                                                               href="/movie/{!!$value['movieID']!!}">{!!$value['name']!!}</a>
                                                        </div>
                                                        ...
                                                        <div class="show-details">
                                                            ...
                                                            <div class="showtimes">
                                                                ...
                                                                <a href="" class="more-showtimes">
                                                                    <small>more shows</small>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="experience-holder" style="z-index: -1;">
                                                        <div class="experience-list">
                                                            <section class="language-based-formats">
                                                                ...
                                                                <div class="content"><a
                                                                            href="/buytickets/brindhaavanam-chennai/movie-chen-ET00057481-MT/20170529/"><span
                                                                                class="__format">2D</span></a></div>
                                                            </section>
                                                        </div>
